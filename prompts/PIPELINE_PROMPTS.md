...
Use the supplied lesson-analysis profile and source excerpt as the primary evidence. Do not score from the title alone or from model memory. Never invent, duplicate, or substitute style IDs.
